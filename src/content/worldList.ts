...
import idiomsStages from "./idioms/stages.json";
...
export const WORLDS: WorldDef[] = [
  ...
  {
    id: "idioms", name: "Idiom Island", icon: "💬", tagline: "What sayings really mean!",
    stages: idiomsStages as StageDef[],
    milestones: [
      { stage: 10, name: "Saying Spotter", icon: "🗣️" },
      { stage: 20, name: "Meaning Finder", icon: "💭" },
      { stage: 30, name: "Figure of Speech", icon: "🎭" },
      { stage: 40, name: "Saying Solver", icon: "🧩" },
      { stage: 50, name: "Saying Sage", icon: "🪄" },
      { stage: 55, name: "Master of Sayings", icon: "🏆" },
    ],
  },
];
